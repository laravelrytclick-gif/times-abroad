...
export default function ComprehensiveServices() {
  return (
    <section id="services" className="bg-gradient-to-br from-slate-50 via-blue-50/30 to-white py-16 sm:py-20 lg:py-24 relative overflow-hidden">
      {/* Background Elements */}
      <div className="absolute top-0 left-0 w-full h-full">
        <div className="absolute top-20 right-10 w-48 h-48 sm:w-80 sm:h-80 bg-blue-100 rounded-full blur-[80px] sm:blur-[120px] opacity-30" />
      ...
      <div className="mx-auto flex items-center justify-center flex-col max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mb-8 sm:mb-12 lg:mb-16 text-left max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4">
            ...
            {/* <a
              href="#"
              className="inline-flex items-center gap-2 font-semibold text-blue-600 hover:text-blue-700 transition-colors text-sm sm:text-base"
            >
        ...
        <div className="grid gap-4 sm:gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="md:col-span-2 lg:col-span-1 lg:row-span-2 rounded-2xl sm:rounded-3xl border border-slate-100 bg-white p-6 sm:p-8 shadow-sm">
            ...
            {/* Image */}
            <div className="relative mt-6 sm:mt-10 h-32 sm:h-40 lg:h-48 w-full overflow-hidden rounded-xl sm:rounded-2xl bg-gradient-to-br from-blue-100 to-blue-50">
              <Image
          ...
          <div className="relative rounded-2xl sm:rounded-3xl bg-slate-900 p-6 sm:p-8 text-white shadow-sm">
            <div className="mb-4 sm:mb-6 flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-xl bg-slate-800">
              <Download size={20} className="sm:w-[22px] sm:h-[22px] text-blue-400" />
            </div>
          ...
          <div className="relative rounded-2xl sm:rounded-3xl border border-slate-100 bg-white p-6 sm:p-8 shadow-sm">
            <div className="mb-4 sm:mb-6 flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-xl bg-blue-100 text-blue-500">
